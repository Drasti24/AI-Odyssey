                ...
                <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-6 md:p-10">
                  ...
                  <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                    <Link to="/algorithms/decision-tree"
                      ...
                      Try Decision Trees <ChevronRight className="h-4 w-4" />
                    </Link>
                    ...
                    <button disabled className="inline-flex items-center gap-2 rounded-xl border border-white/5 bg-white/[0.02] px-6 py-3 font-bold text-white/20 cursor-not-allowed">
